...
public class PictureFrame{
  ...
  public void setUpProfile() {
      ...
      JLabel label = new JLabel("<html>Welcome To Abominodo"
      		+ "<br></html> ", SwingConstants.CENTER);
      
      JLabel label1 = new JLabel("<html>The Best Dominoes Puzzle Game in the Universe"
        		+ "<br></html> ", SwingConstants.CENTER);
      ...
      JTextField tx = new JTextField("Enter Player Name Here", 16);
      ...
      tx.setToolTipText("Enter Player Name Here");
      apt.add(tx);
  ...
  public void setUpMainMenuController() {
      ...
      JLabel label = new JLabel("<html>Main Menu"
      		+ "<br></html> ", SwingConstants.CENTER);
      ...
      button.setBackground(new Color(182, 5, 20));
      button.setForeground(Color.WHITE);
      button.setPreferredSize(new Dimension(200, 38));
      apt.add(button);
      ...
      button2.setBackground(new Color(102, 0, 0));
   ...
   // Button 03 - View Rules
      ...
      button3.setBackground(new Color(102, 0, 0));
  ...
  public void setUpDifficultyLevels() {
      ...
      button.setFont(new java.awt.Font("Comic Sans MS", 1, 16));
      button.setBackground(new Color(106, 90, 50));
      button.setForeground(Color.WHITE);
      ...
      // Button 02 - View high scores
      JButton button2 = new JButton(); 
      button2.setText("Not-so-simples");
      button2.setHorizontalTextPosition(SwingConstants.LEADING); 
      button2.setVerticalTextPosition(SwingConstants.BOTTOM);    
      button2.setFont(new java.awt.Font("Comic Sans MS", 1, 16));
      button2.setBackground(new Color(102, 0, 5));
      button2.setForeground(Color.WHITE);
   ...
   // Button 03 - View Rules
      JButton button3 = new JButton(); 
      button3.setText("Super-duper-shuffled");
      button3.setHorizontalTextPosition(SwingConstants.LEADING); 
      button3.setVerticalTextPosition(SwingConstants.BOTTOM); 
      button3.setHorizontalAlignment(SwingConstants.CENTER); 
      button3.setFont(new java.awt.Font("Comic Sans MS", 1, 16));
      button3.setBackground(new Color(106, 95, 50));
      button3.setForeground(Color.WHITE);
